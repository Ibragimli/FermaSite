...
{
    public class PosterPaymentIndexServices : IPosterPaymentIndexServices
    {
        private readonly IUnitOfWork _unitOfWork;

        public PosterPaymentIndexServices(IUnitOfWork unitOfWork)
        {
        ...
        public IQueryable<Payment> GetPayments(int year, int month)
        {
            ...
            payments = payments.Where(x => x.Service == PaymentService.PosterPayment);
            if (year != 0)
